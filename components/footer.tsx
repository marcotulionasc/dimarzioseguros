          ...
          <div className="md:col-span-5 text-center md:text-left">
            ...
            <address className="not-italic space-y-4">
              <div className="flex items-start gap-3 text-gray-400 justify-center md:justify-start">
                ...
                <p className="text-gray-400">Rua Cumaru, 219 - sala 16<br />Campinas - SP</p>
              </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-center md:text-left">
            <p className="text-gray-400">© 2025 Dimarzio Seguros. Todos os direitos reservados.</p>
            <p className="text-gray-400">CNPJ: 10.894.914/0001-05</p>
          </div>
        </div>
      </div>
    </footer>
