...
import { Heart, Shield, CheckCircle2, ArrowRight, Users, Clock, Star, AlertTriangle } from 'lucide-react'
                ...
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    showError(
                      ...
                      'Ocorreu um erro ao enviar sua análise. Por favor, tente novamente ou entre em contato conosco pelo telefone (19) 3294-0655.'
                    );
                  }
                }}
              >
